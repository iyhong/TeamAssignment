...
class Ship_cym extends Elect_cym implements Testable_cym{
...
class Robot_cym extends Elect_cym implements Testable_cym {
	...
	void test(Testable_cym t) {
		...
		if (t instanceof Elect_cym) { //instanceOf메서드는 t객체가 Elect를 참조할 수 있으면 true 없으면 false값을 리턴한다.
